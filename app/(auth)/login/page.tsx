...
// 1. Move all the logic and UI inside this internal content component
...
// 2. Keep the export file clean and wrapped nicely in Suspense
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center p-4 font-padauk">
        ...
        {/* Suspense fixes the prerender missing context failure */}
        <Suspense fallback={
          <div className="flex flex-col items-center gap-2 text-slate-400">
            <Loader2 size={32} className="animate-spin text-primary" />
            <p className="text-xs">Loading Secure Connection...</p>
          </div>
        }>
          <LoginFormContent />
        </Suspense>
